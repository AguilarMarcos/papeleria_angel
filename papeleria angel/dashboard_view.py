...
class DashboardView:
    def __init__(self, root, usuario):
        ...
        if usuario['rol'] == 'admin':
            buttons.extend([
                ...
                ("🛒 Pedidos / Órdenes de Compra", self.open_pedidos, "#2980b9"),
        ...
        for i, (text, command, color) in enumerate(buttons):
            ...
            # ✅ Responsive: 2 columnas, centrado verticalmente
            row = i // 2
            col = i % 2
    ...
    def _open_view_safe(self, ViewClass, module_name=""):
        ...
        def load_in_thread():
            try:
                ...
                # ✅ Closure para limpieza específica
                def on_close():
                ...
                # ✅ Mostrar dashboard de nuevo si falla la vista
                try:
                ...
                messagebox.showerror("❌ Error crítico", f"Fallo al crear ventana:\n{e}", parent=self.root)
                self.root.deiconify()
            finally:
    ...
    def open_pedidos(self):
        try:
            ...
            self._open_view_safe(PedidosView, "Órdenes de Compra")
        except ImportError as e:
            self._hide_loading()
            messagebox.showerror("❌ Módulo faltante", f"No se encontró 'pedidos_view.py':\n{e}")
